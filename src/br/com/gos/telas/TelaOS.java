...
public class TelaOS extends javax.swing.JInternalFrame {
    ...
    //a linha abaioxo cria uma variável apra armazenar um texto de acordo com o radion button selecionado
    private String tipo;
    ...
    //metodo apra pesquisar uma OS
    private void pesquisar_os() {
        // a linha abaixo cria uma caixa entrada do tipo JOption Pane
...
//método para alterar uma OS
    ...
    private void btnOsAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOsAdicionarActionPerformed
        // Chamar o método de emitir OS
        emitir_os();
    }//GEN-LAST:event_btnOsAdicionarActionPerformed

    private void btnOsPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOsPesquisarActionPerformed
        // Chamar o método chamar os
        pesquisar_os();
    ...
    private void btnOsImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOsImprimirActionPerformed
        // Chamando o método para imprimirr uma Ordemd e Serviço
        imprimir_os();
